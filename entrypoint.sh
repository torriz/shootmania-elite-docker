...
# Make sure we use defaults everywhere (DO NOT EDIT! Set desired settings in dedicated_vars.env instead).
...
cp -r ${TEMPLATE_DIR}/Maps/ ${PROJECT_ROOT}/UserData/Maps/
...
# TODO: Consider using curl instead
